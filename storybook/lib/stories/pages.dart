  ...
  Story(
    ...
    builder:
        (context) => LogInPage(
          ...
          onPressedForgotPassword: context.knobOnPressed(
            label: 'ForgotPassword Button',
          ),
  ...
  Story(
    ...
    builder:
        (context) => RegistrationPage(
          ...
          onPressedRegister: context.knobOnPressedOptional(
  ...
  Story(
    ...
    builder:
        (context) => ForgotPasswordPage(
          ...
          email: context.newInputVm('Email'),
          onPressedResetPassword: context.knobOnPressedOptional(
            label: 'Register Button',
          ),
          onPressedBackToLogin: context.knobOnPressed(label: 'Back to Login'),
        ),
