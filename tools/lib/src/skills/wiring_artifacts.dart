/// The router that sits over the command skills: which `frx` command wires the
/// artifact about to be written, and the rules that belong to no single one.
///
/// Authored, like `asyncReduxSkill` and `dataDrivenWidgetsSkill`: the command
/// skills say how one artifact is written, and this is what none of them can
/// carry — the transaction a batch is, what deletion means here, and where the
/// body of a reducer is explained.
const wiringArtifactsSkill = '''
---
