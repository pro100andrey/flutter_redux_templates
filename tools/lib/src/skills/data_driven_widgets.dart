...
///
/// Authored rather than derived, like `asyncReduxSkill`. What makes it a skill
/// and not a paragraph in the router is when it has to fire — at the moment
/// someone is about to write a widget or a `fromStore`, which is before any
/// `frx` command runs and often instead of one.
const dataDrivenWidgetsSkill = '''
---
